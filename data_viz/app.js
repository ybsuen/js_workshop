/* <script type="text/javascript"> */
      var public_spreadsheet_url = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTzAUVeFq2IQR7aDOuiACxRjmXicRqoJrqak53Gvej-Tb-RQdZI8ZpkflSJOR0XbrR6qrqqvg9pxzgn/pub?gid=1037024612&single=true&output=csv';
      ...
      function showInfo(results) {
        ...
        for (i=0; i < data.length; i++ ) {
          districts = districts + "<br>" + data[i].chi_district
          items = []
